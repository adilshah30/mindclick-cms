                        ...
                        <div id="table-datatables">           
                          <div class="row">
                          	<div class="col m12 mb-5">
                          		<a href="<?php echo site_url('admin/feature/new_record/'); ?>" class="btn waves-effect waves-light pull-right" type="submit" name="action">Add New</a>
                            </div>    
                            <div class="confirm-div"></div>
                            <div class="col m12 ">
                              <table id="feature-listing-table" class="responsive-table display dataTable">
                                <thead>
                                    <tr>
                                    	<th>Sr.No</th>                                
                                        <th>Feature Name</th>
