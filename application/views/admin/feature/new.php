                          ...
                          <div class="row">
                            <div class="col s12 m12 l6">
                              <div class="card-panel">
                                <h4 class="header2 nmt"><button class="btn-floating btn-small waves-effect waves-light "><i class="mdi-content-add"></i></button> &nbsp; Add New Feature</h4>
                                <div class="row">
                                	
                                  <form class="col s12 formValidate" id="admin-feature-form" role="form" action="<?php echo site_url('admin/feature/add'); ?>" method="post" enctype="multipart/form-data">
                                  	<?php $this->load->view('admin/feature/form'); ?>                                    
                                    <div class="row">
