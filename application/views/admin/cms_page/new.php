                      ...
                      <div class="container">
                        <div class="row">
                          <div class="col s12 m12 l12">
                            <h5 class="breadcrumbs-title">Add New Page</h5>
                        ...
                        <div id="basic-form" class="section">
                          <div class="row">
                            <div class="col s12 m12">
                              <div class="">
                                <!--<h4 class="header2 nmt"><button class="btn-floating btn-small waves-effect waves-light "><i class="mdi-content-add"></i></button> &nbsp; Add New Role</h4>-->
                                
                                <div class="row">
                                	
                                  <form class="col s12 formValidate" id="admin-cms-page-form" role="form" action="<?php echo site_url('admin/cmspage/add'); ?>" method="post" enctype="multipart/form-data">
                                      <input type="hidden" value="page" name="PostType"> 	
                                      <?php $this->load->view('admin/cms_page/form'); ?>                                     
                                  </form>
                                </div>
                              </div>
                            </div>
