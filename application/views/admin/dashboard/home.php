                    ...
                    <div id="card-widgets">
                            ...
                            <div class="col s12 m6 l4">
                                <div id="profile-card" class="card">
                                    <div class="card-image waves-effect waves-block waves-light">
                                        <img class="activator" src="<?php echo site_url('assets') ; ?>/images/user-bg.jpg" alt="user background">
                                    </div>
                                    <div class="card-content">
                                        <img src="<?php echo site_url('assets') ; ?>/images/avatar.jpg" alt="" class="circle responsive-img activator card-profile-image">
                        ...
                        <div class="row">
                            ...
                            <div class="col s12 m12 l4">
                                ...
                                <div class="card">
                                    <div class="card-image waves-effect waves-block waves-light">
                                        <img src="<?php echo site_url('assets') ; ?>/images/gallary/30.jpg" alt="blog-img">
                                    </div>
                                ...
                                <div class="product-card">
                                    <div class="card">
                                        <div class="card-image waves-effect waves-block waves-light">
                                            ...
                                            <img src="<?php echo site_url('assets') ; ?>/images/gallary/33.jpg" alt="product-img">
                                        </div>
                                        <ul class="card-action-buttons">
                                        ...
                                        <div class="card-content">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col s4 no-padding">
                                                    <a href=""></a><img src="<?php echo site_url('assets') ; ?>/images/amazon.jpg" alt="amazon" class="responsive-img">
