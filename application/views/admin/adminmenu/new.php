                      ...
                      <div class="container">
                        <div class="row">
                          <div class="col s12 m12 l12">
                            <h5 class="breadcrumbs-title">Feature</h5>
                            <ol class="breadcrumbs">
                                <li><a href="">Dashboard</a></li>
                                <li><a href="#">Manage Feature</a></li>
                          ...
                          <div class="row">
                            <div class="col s12 m12 l6">
                              <div class="card-panel">
                                <h4 class="header2 nmt"><button class="btn-floating btn-small waves-effect waves-light "><i class="mdi-content-add"></i></button> &nbsp; Add New Menu Item</h4>
                                <div class="row">
                                	
                                  <form class="col s12 formValidate" id="admin-feature-form" role="form" action="<?php echo site_url('admin/adminmenu/add'); ?>" method="post" enctype="multipart/form-data">
                                  	<?php $this->load->view('admin/adminmenu/form'); ?>                                    
                                    <div class="row">
