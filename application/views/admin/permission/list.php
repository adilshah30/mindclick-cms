                      ...
                      <div class="container">
                        <div class="row">
                          <div class="col s12 m12 l12">
                            <h5 class="breadcrumbs-title">Permission</h5>
                        ...
                        <div id="table-datatables">           
                          <div class="row">
                          	<div class="col m12 mb-5">
                          		<a href="<?php echo site_url('admin/permission/new_record/'); ?>" class="btn waves-effect waves-light pull-right" type="submit" name="action">Add New</a>
                            </div>    
                            <div class="confirm-div"></div>
                            <div class="col m12 ">
                              <table id="permission-listing-table" class="responsive-table display dataTable">
                                <thead>
                                    <tr>
                                    	<th>Sr.No</th>                                
