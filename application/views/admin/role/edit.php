                          ...
                          <div class="row">
                            <div class="col s12 m12 l6">
                              <div class="card-panel">
                                ...
                                <div class="row">                                	
                                  <form class="col s12 formValidate" id="role-form" role="form" action="<?php echo site_url('admin/role/update'); ?>" method="post" enctype="multipart/form-data">
                                    <input type="hidden" value="<?php echo $dt->RoleID ?>" name="RoleID">
                                  	<?php $this->load->view('admin/role/form'); ?>                                    
                                    <div class="row">
